                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.only(top: height / 6, left: D.horizontalPadding + 1),
                      child:
                          Image.asset(S.assetEsummitLogoWhite, width: width * 0.3 * heightFactor),
                    ),
                    Container(
                      alignment: Alignment.centerLeft,
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Icon(Icons.arrow_forward_ios,
                                    color: C.primaryUnHighlightedColor, size: heightFactor * 20),
                              ],
                            ),
                          ),
                        ),
